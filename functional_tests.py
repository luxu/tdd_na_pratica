...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # A página é atualizada novamente e agora mlstra os dois itens em sua lista

        # Edith se pergunta se o site lembrará de sua lista. Então ele nota
        # que o site gerou uma URL único para ela -- há um pequeno
